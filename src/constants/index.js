...
import project3 from '../assets/projects/ves.png'
...
export const PROJECTS = [
  ...
  {
    title: 'VES Business Website',
    image: project3,
    description:
      'Created a static website for VES Vedant Electrical Services using Next.js. The site includes pages like Home, About, Services, Expertise, Enquiry, and Contact, giving visitors a clear overview of the company and what they offer. It’s a clean and easy-to-navigate website made to represent the business online.',
    technologies: [
      'Next.js',
      'Framer Motion',
      'Tailwind CSS',
    ],
    link: 'https://vedantelectrical.in/',
  },
  {
